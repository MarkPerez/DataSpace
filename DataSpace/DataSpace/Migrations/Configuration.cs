namespace DataSpace.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DataSpace.Models.planetsEntities>
    {
        ...
        protected override void Seed(DataSpace.Models.planetsEntities context)
        {
